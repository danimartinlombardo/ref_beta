...
try:
	...
	slack_message('Unable read bonus request data: '+ str(e))
	exit()
...
for request in requests:
	try:
		...
		cur_pg_google.execute('''
				INSERT INTO staging.referral_bonus_request(
		...
		slack_message('Unable to insert bonus requests data: '+ str(e))
		exit()

#UPDATE BONUS ID ON PARTICIPANTS
# try:
# 	cur_pg.execute('''
# 		UPDATE bp.referral_participants_temp_2
# 		SET
# 			bonus_request_id = b.referral_bonus_id,
#     		updated_at_utc = Now()
#     	FROM (
#     		SELECT
#     			referral_bonus_id,
...
#     			) b
#     	WHERE referral_participants_temp.applicant_id = b.applicant_id;
# 		''')
# 	con_pg.commit()
# 	print ('Bonus id updated.')
# except psycopg2.Error as e:
# 	print('Unable to update bonus request id: '+ str(e))
# 	slack_message('Unable to update bonus request id: '+ str(e))
# 	exit()	
